...
import org.mperezcastell.ImPatient.service.auth.OAuth2SecurityConfiguration;
...
public class Application extends RepositoryRestMvcConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "org.mperezcastell.ImPatient.service" });
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/ImPa");
